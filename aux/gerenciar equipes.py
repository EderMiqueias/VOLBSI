...
class gerenciar_clubes:
    ...
    def menu(self):
        while True:
            ...
            print('00 - VOLTAR E ABRIR JANELA DO MENU PRINCIPAL')
    ...
    def importar_clube(self):
        ...
        save.close()
        if len(self.dict_equipes) < 6 and ha_times:
            ...
            while True:
                ...
                if not id_jogador in self.dict_jogadores:
                    ...
                    print("\nEste jogador ja esta em um time chamado", dict_jogadores[id_jogador][5])
...
gerenciamento = gerenciar_clubes()
